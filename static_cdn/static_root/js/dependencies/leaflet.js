...
!function (t, e) {
    ...
    var K = "data:images/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=";
    ...
    var _i = di.extend({
        options: {
            ...
            var t = P("div", "leaflet-default-icon-path", document.body),
                e = pe(t, "background-images") || pe(t, "backgroundImage");
    ...
    var Mt = Si, Ei = o.extend({
        ...
        _initImage: function () {
            ...
            if (M(e, "leaflet-images-layer"), this._zoomAnimated && M(e, "leaflet-zoom-animated"), this.options.className && M(e, this.options.className), e.onselectstart = u, e.onmousemove = u, e.onloadeddata = a(this.fire, this, "load"), t) {
    ...
    var Oi = Ei.extend({
        _initImage: function () {
            ...
            M(t, "leaflet-images-layer"), this._zoomAnimated && M(t, "leaflet-zoom-animated"), this.options.className && M(t, this.options.className), t.onselectstart = u, t.onmousemove = u
        }
    });
    var Ai = o.extend({
